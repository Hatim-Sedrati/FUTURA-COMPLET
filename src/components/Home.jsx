...
import xabaka from "../assets/images/XBKA.png";
...
export default function Home() {
    ...
    return (
        ...
        ============================= */}
                <div
                    className={`absolute right-0 top-[67%] -translate-y-1/2 pointer-events-none transition-opacity duration-700 ${showXabaka ? "opacity-100" : "opacity-0"
                        }`}
                    style={{
                        zIndex: 15,
