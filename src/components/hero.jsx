    ...
    return (
        <section className="relative pt-32 pb-24 px-8 bg-gradient-to-b from-[#071033] via-[#02173b] to-[#6b0b8a]">
            <div className="max-w-7xl mx-auto text-center relative">
                ...
                {/* Title */}
                <h1
                    className={`text-7xl md:text-8xl font-orbitron font-bold tracking-[0.15em] uppercase text-white mb-8 transition-all duration-1000 ${animateText ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                        }`}
                >
                ...
                {/* Subtitle */}
                <p
                    className={`text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light transition-all duration-1000 delay-200 font-body ${animateText ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                        }`}
                >
                ...
                border-black/60 shadow-2xl transition duration-1000 ease-out ${animateText
