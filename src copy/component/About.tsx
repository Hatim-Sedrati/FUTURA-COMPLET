...
// images
import AminaImg from "../PICS/Amina.png";
import AnassImg from "../PICS/Anass.png";
import HafsaImg from "../PICS/Hafsa.png";
import HatimImg from "../PICS/Hatim.png";
import HatimmImg from "../PICS/Hatimm.png";
import IbrahimImg from "../PICS/Ibrahim.png";
import LeilaImg from "../PICS/Leila.png";
import MarouaneImg from "../PICS/Marouane.png";
import MohamedImg from "../PICS/Mohamed.png";
import NabilImg from "../PICS/Nabil.png";
import OumaymaImg from "../PICS/Oumayma.png";
import RiahbImg from "../PICS/Riahb El khiat.png";
import RihabKhlifiImg from "../PICS/Rihab El Khlifi.png";
import RiyadImg from "../PICS/Riyad.png";
import SafaaImg from "../PICS/Safaa.png";
import ZaidImg from "../PICS/Zaid.png";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-purple-700 text-white">
      ...
      <footer className="text-center py-8 text-sm text-purple-200">
        © 2025 Futura Inc. Tous droits réservés
      </footer>
    </div>
  );
}
